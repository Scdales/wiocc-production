 ...
 * Time: 10:19 PM
 */
function custom_post_type_Director() {

	$labels = array(
		'name'                  => _x( 'Directors', 'Post Type General Name', 'wiocc' ),
		'singular_name'         => _x( 'Director', 'Post Type Singular Name', 'wiocc' ),
		'menu_name'             => __( 'Directors', 'wiocc' ),
		'name_admin_bar'        => __( 'Director', 'wiocc' ),
		'archives'              => __( 'Director Archives', 'wiocc' ),
		'attributes'            => __( 'Director Attributes', 'wiocc' ),
	...
	$args = array(
		'label'                 => __( 'Director', 'wiocc' ),
		'description'           => __( 'Director Description', 'wiocc' ),
		'labels'                => $labels,
...
add_action( 'init', 'custom_post_type_Director', 0 );
function wiocc_get_director_meta_box( $meta_boxes ) {
	$prefix = 'wiocc-';
	/** Post */
	$meta_boxes[] = array(
		'id' => 'News',
		'title' => esc_html__( 'Heading', 'wiocc' ),
		'post_types' => array( 'director' ),
		'context' => 'advanced',
		'priority' => 'default',
		'autosave' => true,
		'fields' => array(
			array(
				'id' => $prefix . 'company',
				'type' => 'text',
				'name' => esc_html__( 'Company', 'wiocc' ),
			),
			array(
				'id' => $prefix . 'title',
				'type' => 'text',
				'name' => esc_html__( 'Title / Position', 'wiocc' ),
			),
			array(
				'id' => $prefix . 'company_logo',
				'name' => esc_html__( 'Company Logo', 'wiocc' ),
				'type' => 'image_advanced',
				'desc' => esc_html__( 'Logo of represented company', 'wiocc' ),
				'max_file_uploads' => '1',
			),
			array(
				'id' => $prefix . 'featured',
				'name' => esc_html__( 'Is Featured', 'wiocc' ),
				'type' => 'checkbox',
				'desc' => esc_html__( 'Shows up on the top', 'wiocc' ),
			),
		),
	);
...
add_filter( 'rwmb_meta_boxes', 'wiocc_get_director_meta_box' );
