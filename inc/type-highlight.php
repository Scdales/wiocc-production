...
function custom_post_type_Highlight() {
	...
	$labels = array(
		'name'                  => _x( 'Highlights', 'Post Type General Name', 'wiocc' ),
		'singular_name'         => _x( 'Highlight', 'Post Type Singular Name', 'wiocc' ),
		'menu_name'             => __( 'Highlights', 'wiocc' ),
		'name_admin_bar'        => __( 'Highlight', 'wiocc' ),
		'archives'              => __( 'Highlight Archives', 'wiocc' ),
		'attributes'            => __( 'Highlight Attributes', 'wiocc' ),
	...
	$args = array(
		'label'                 => __( 'Highlight', 'wiocc' ),
		'description'           => __( 'Highlight Description', 'wiocc' ),
		'labels'                => $labels,
...
add_image_size('highlight', 401, 208);
add_post_type_support( 'highlight', 'excerpt' );

function wiocc_get_Highlight_meta_box( $meta_boxes ) {
	$prefix = 'wiocc-';
	/** Post */
	$meta_boxes[] = array(
		'id' => 'Highlight',
		'title' => esc_html__( 'Heading', 'wiocc' ),
		'post_types' => array( 'Highlight' ),
		'context' => 'advanced',
		'priority' => 'default',
		'autosave' => true,
		'fields' => array(
			array(
				...
				'type' => 'text',
				'name' => esc_html__( 'Heading Part2 Label', 'wiocc' ),
			),
			array(
				'id' => $prefix . 'cta_label',
				'type' => 'text',
	...
	$meta_boxes[] = array(
		'id' => 'highlight-cta',
		'title' => esc_html__( 'Linked Content', 'wiocc' ),
		'post_types' => array( 'highlight' ),
		'context' => 'advanced',
		'priority' => 'default',
		'autosave' => false,
		'fields' => array(
            ...
            array(
                'id' => $prefix . 'map_link',
                'type' => 'text',
                'name' => esc_html__( 'Link to map', 'wiocc' ),
            ),
		),
	);
...
add_filter( 'rwmb_meta_boxes', 'wiocc_get_Highlight_meta_box' );
